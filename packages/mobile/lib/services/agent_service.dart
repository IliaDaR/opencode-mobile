...
""";
  ...
  static final List<Map<String, dynamic>> _tools = [
    ...
    { "type":"function","function":{ "name":"read_file","description":"Read the contents of a file.","parameters":{"type":"object","properties":{"project":{"type":"string"},"path":{"type":"string"}},"required":["project","path"]}}},
    { "type":"function","function":{ "name":"write_file","description":"Write content to a file.","parameters":{"type":"object","properties":{"project":{"type":"string"},"path":{"type":"string"},"content":{"type":"string"}},"required":["project","path","content"]}}},
    { "type":"function","function":{ "name":"list_files","description":"List files in a directory.","parameters":{"type":"object","properties":{"project":{"type":"string"},"path":{"type":"string"}},"required":["project","path"]}}},
    { "type":"function","function":{ "name":"delete_file","description":"Delete a file.","parameters":{"type":"object","properties":{"project":{"type":"string"},"path":{"type":"string"}},"required":["project","path"]}}},
    { "type":"function","function":{ "name":"search_code","description":"Search code for a pattern.","parameters":{"type":"object","properties":{"project":{"type":"string"},"pattern":{"type":"string"},"fileExt":{"type":"string"}},"required":["project","pattern"]}}},
    { "type":"function","function":{ "name":"glob_files","description":"Find files matching a glob pattern.","parameters":{"type":"object","properties":{"project":{"type":"string"},"pattern":{"type":"string"}},"required":["project","pattern"]}}},
    { "type":"function","function":{ "name":"run_command","description":"Run a shell command in the project.","parameters":{"type":"object","properties":{"project":{"type":"string"},"command":{"type":"string"},"cwd":{"type":"string"}},"required":["project","command"]}}},
    { "type":"function","function":{ "name":"web_search","description":"Search the web for information.","parameters":{"type":"object","properties":{"query":{"type":"string"},"max_results":{"type":"integer"}},"required":["query"]}}},
    ...
    { "type":"function","function":{ "name":"ask_user","description":"Ask the user a question.","parameters":{"type":"object","properties":{"question":{"type":"string"},"options":{"type":"array","items":{"type":"string"}}},"required":["question"]}}},
    { "type":"function","function":{ "name":"impact_analysis","description":"Analyze the impact of changes to a file.","parameters":{"type":"object","properties":{"project":{"type":"string"},"file_path":{"type":"string"}},"required":["project","file_path"]}}},
    { "type":"function","function":{ "name":"git_sync","description":"Commit and sync changes with a message.","parameters":{"type":"object","properties":{"project":{"type":"string"},"message":{"type":"string"}},"required":["project","message"]}}},
    { "type":"function","function":{ "name":"git_status","description":"Get the git status of the project.","parameters":{"type":"object","properties":{"project":{"type":"string"}},"required":["project"]}}},
    { "type":"function","function":{ "name":"github_list_issues","description":"List GitHub issues for a repository.","parameters":{"type":"object","properties":{"owner":{"type":"string"},"repo":{"type":"string"},"state":{"type":"string"},"label":{"type":"string"}},"required":["owner","repo","state","label"]}}},
    { "type":"function","function":{ "name":"github_create_issue","description":"Create a GitHub issue.","parameters":{"type":"object","properties":{"owner":{"type":"string"},"repo":{"type":"string"},"title":{"type":"string"},"body":{"type":"string"},"labels":{"type":"array","items":{"type":"string"}}},"required":["owner","repo","title","body","labels"]}}},
    { "type":"function","function":{ "name":"github_list_prs","description":"List pull requests for a repository.","parameters":{"type":"object","properties":{"owner":{"type":"string"},"repo":{"type":"string"},"state":{"type":"string"}},"required":["owner","repo","state"]}}},
    { "type":"function","function":{ "name":"github_get_pr","description":"Get a specific pull request.","parameters":{"type":"object","properties":{"owner":{"type":"string"},"repo":{"type":"string"},"number":{"type":"integer"}},"required":["owner","repo","number"]}}},
    { "type":"function","function":{ "name":"github_search_code","description":"Search code on GitHub.","parameters":{"type":"object","properties":{"query":{"type":"string"}},"required":["query"]}}},
    { "type":"function","function":{ "name":"github_get_file","description":"Get a file from a GitHub repository.","parameters":{"type":"object","properties":{"owner":{"type":"string"},"repo":{"type":"string"},"path":{"type":"string"},"ref":{"type":"string"}},"required":["owner","repo","path","ref"]}}},
    { "type":"function","function":{ "name":"github_get_repo","description":"Get repository information from GitHub.","parameters":{"type":"object","properties":{"owner":{"type":"string"},"repo":{"type":"string"}},"required":["owner","repo"]}}},
    { "type":"function","function":{ "name":"create_pr","description":"Create a pull request.","parameters":{"type":"object","properties":{"owner":{"type":"string"},"repo":{"type":"string"},"title":{"type":"string"},"body":{"type":"string"},"head":{"type":"string"},"base":{"type":"string"}},"required":["owner","repo","title","body","head","base"]}}},
    { "type":"function","function":{ "name":"diagnose_file","description":"Diagnose issues in a file.","parameters":{"type":"object","properties":{"project":{"type":"string"},"file_path":{"type":"string"}},"required":["project","file_path"]}}},
    { "type":"function","function":{ "name":"analyze_project","description":"Analyze the entire project structure and health.","parameters":{"type":"object","properties":{"project":{"type":"string"}},"required":["project"]}}},
    { "type":"function","function":{ "name":"check_imports","description":"Check import statements in a file.","parameters":{"type":"object","properties":{"project":{"type":"string"},"file_path":{"type":"string"}},"required":["project","file_path"]}}},
    { "type":"function","function":{ "name":"find_patterns","description":"Find code patterns in the project.","parameters":{"type":"object","properties":{"project":{"type":"string"},"pattern":{"type":"string"}},"required":["project","pattern"]}}},
    { "type":"function","function":{ "name":"suggest_tests","description":"Suggest tests for a file.","parameters":{"type":"object","properties":{"project":{"type":"string"},"file_path":{"type":"string"}},"required":["project","file_path"]}}},
    { "type":"function","function":{ "name":"suggest_optimizations","description":"Suggest optimizations for code.","parameters":{"type":"object","properties":{"code":{"type":"string"}},"required":["code"]}}},
    { "type":"function","function":{ "name":"estimate_effort","description":"Estimate development effort for a task.","parameters":{"type":"object","properties":{"description":{"type":"string"}},"required":["description"]}}},
    { "type":"function","function":{ "name":"check_deps","description":"Check project dependencies.","parameters":{"type":"object","properties":{"project":{"type":"string"}},"required":["project"]}}},
    { "type":"function","function":{ "name":"create_tasks","description":"Create development tasks in the project.","parameters":{"type":"object","properties":{"project":{"type":"string"},"tasks":{"type":"array","items":{"type":"string"}}},"required":["project","tasks"]}}},
    { "type":"function","function":{ "name":"todowrite","description":"Write tasks to the project todo list.","parameters":{"type":"object","properties":{"project":{"type":"string"},"tasks":{"type":"array","items":{"type":"string"}}},"required":["project","tasks"]}}},
    { "type":"function","function":{ "name":"todolist","description":"List tasks in the project todo list.","parameters":{"type":"object","properties":{"project":{"type":"string"}},"required":["project"]}}},
    { "type":"function","function":{ "name":"delegate_task","description":"Delegate a task to another agent.","parameters":{"type":"object","properties":{"agent_type":{"type":"string"},"task":{"type":"string"}},"required":["agent_type","task"]}}},
    { "type":"function","function":{ "name":"run_background","description":"Run a task in the background.","parameters":{"type":"object","properties":{"agent_type":{"type":"string"},"task":{"type":"string"}},"required":["agent_type","task"]}}},
    { "type":"function","function":{ "name":"snapshot_undo","description":"Undo changes to a file using snapshot.","parameters":{"type":"object","properties":{"project":{"type":"string"},"file_path":{"type":"string"}},"required":["project","file_path"]}}},
    { "type":"function","function":{ "name":"snapshot_undo_all","description":"Undo all changes in the project using snapshots.","parameters":{"type":"object","properties":{"project":{"type":"string"}},"required":["project"]}}},
    { "type":"function","function":{ "name":"check_deploy_readiness","description":"Check if the project is ready for deployment.","parameters":{"type":"object","properties":{"project":{"type":"string"}},"required":["project"]}}},
    { "type":"function","function":{ "name":"generate_docker_compose","description":"Generate a docker-compose.yml file.","parameters":{"type":"object","properties":{"stack":{"type":"string"},"config":{"type":"object"}},"required":["stack","config"]}}},
    { "type":"function","function":{ "name":"generate_ci_config","description":"Generate CI/CD configuration.","parameters":{"type":"object","properties":{"platform":{"type":"string"},"node_version":{"type":"string"},"python_version":{"type":"string"}},"required":["platform"]}}},
    { "type":"function","function":{ "name":"mcp_call","description":"Call an MCP server tool.","parameters":{"type":"object","properties":{"url":{"type":"string"},"tool":{"type":"string"},"args":{"type":"object"}},"required":["url","tool","args"]}}},
    { "type":"function","function":{ "name":"diff_preview","description":"Preview a diff before applying changes.","parameters":{"type":"object","properties":{"project":{"type":"string"},"file_path":{"type":"string"},"old_string":{"type":"string"},"new_string":{"type":"string"}},"required":["project","file_path","old_string","new_string"]}}},
    { "type":"function","function":{ "name":"batch_execute","description":"Execute multiple tool calls in batch.","parameters":{"type":"object","properties":{"calls":{"type":"array","items":{"type":"object"}}},"required":["calls"]}}},
    { "type":"function","function":{ "name":"profile_performance","description":"Profile performance of a file.","parameters":{"type":"object","properties":{"project":{"type":"string"},"file_path":{"type":"string"}},"required":["project","file_path"]}}},
    { "type":"function","function":{ "name":"self_review","description":"Self-review code quality.","parameters":{"type":"object","properties":{"project":{"type":"string"},"file_path":{"type":"string"}},"required":["project"]}}},
    { "type":"function","function":{ "name":"detect_conflicts","description":"Detect merge conflicts in the project.","parameters":{"type":"object","properties":{"project":{"type":"string"}},"required":["project"]}}},
    { "type":"function","function":{ "name":"analyze_function","description":"Analyze a specific function.","parameters":{"type":"object","properties":{"project":{"type":"string"},"file_path":{"type":"string"},"function_name":{"type":"string"}},"required":["project","file_path","function_name"]}}},
    { "type":"function","function":{ "name":"create_plan","description":"Create an execution plan for a task.","parameters":{"type":"object","properties":{"task":{"type":"string"}},"required":["task"]}}},
    { "type":"function","function":{ "name":"project_summary","description":"Generate a summary of the project.","parameters":{"type":"object","properties":{"project":{"type":"string"}},"required":["project"]}}},
    { "type":"function","function":{ "name":"browser_open","description":"Open a URL in the browser.","parameters":{"type":"object","properties":{"url":{"type":"string"}},"required":["url"]}}},
    { "type":"function","function":{ "name":"browser_extract","description":"Extract content from a URL.","parameters":{"type":"object","properties":{"url":{"type":"string"},"pattern":{"type":"string"}},"required":["url","pattern"]}}},
    { "type":"function","function":{ "name":"browser_follow","description":"Follow a link on a page.","parameters":{"type":"object","properties":{"url":{"type":"string"},"link_text":{"type":"string"}},"required":["url","link_text"]}}},
    { "type":"function","function":{ "name":"sql_detect","description":"Detect SQLite databases in the project.","parameters":{"type":"object","properties":{"project":{"type":"string"}},"required":["project"]}}},
    { "type":"function","function":{ "name":"sql_query","description":"Run a SQL query on a database.","parameters":{"type":"object","properties":{"project":{"type":"string"},"db_file":{"type":"string"},"query":{"type":"string"}},"required":["project","db_file","query"]}}},
    { "type":"function","function":{ "name":"sql_schema","description":"Get the schema of a SQLite database.","parameters":{"type":"object","properties":{"project":{"type":"string"},"db_file":{"type":"string"}},"required":["project","db_file"]}}},
    { "type":"function","function":{ "name":"api_test","description":"Test an API endpoint.","parameters":{"type":"object","properties":{"method":{"type":"string","enum":["GET","POST"]},"url":{"type":"string"},"body":{"type":"string"},"headers":{"type":"object"}},"required":["method","url"]}}},
    { "type":"function","function":{ "name":"debate","description":"Run a debate between two agents.","parameters":{"type":"object","properties":{"topic":{"type":"string"},"agent1":{"type":"string"},"agent2":{"type":"string"}},"required":["topic","agent1","agent2"]}}},
    { "type":"function","function":{ "name":"security_scan","description":"Scan the project for security issues.","parameters":{"type":"object","properties":{"project":{"type":"string"}},"required":["project"]}}},
    { "type":"function","function":{ "name":"format_code","description":"Format code in a file.","parameters":{"type":"object","properties":{"project":{"type":"string"},"file_path":{"type":"string"}},"required":["project","file_path"]}}},
    { "type":"function","function":{ "name":"run_code","description":"Run a code snippet.","parameters":{"type":"object","properties":{"project":{"type":"string"},"code":{"type":"string"},"language":{"type":"string"}},"required":["project","code","language"]}}},
    { "type":"function","function":{ "name":"generate_readme","description":"Generate a README.md file.","parameters":{"type":"object","properties":{"project_name":{"type":"string"},"description":{"type":"string"},"tech_stack":{"type":"string"}},"required":["project_name","description","tech_stack"]}}},
    { "type":"function","function":{ "name":"generate_api_docs","description":"Generate API documentation from source.","parameters":{"type":"object","properties":{"project":{"type":"string"},"source_file":{"type":"string"}},"required":["project","source_file"]}}},
    { "type":"function","function":{ "name":"generate_boilerplate","description":"Generate boilerplate project code.","parameters":{"type":"object","properties":{"project_type":{"type":"string"},"name":{"type":"string"}},"required":["project_type","name"]}}},
    { "type":"function","function":{ "name":"generate_test_template","description":"Generate a test template from source file.","parameters":{"type":"object","properties":{"project":{"type":"string"},"source_file":{"type":"string"}},"required":["project","source_file"]}}},
    { "type":"function","function":{ "name":"edit_file","description":"Edit a file by replacing old text with new text.","parameters":{"type":"object","properties":{"project":{"type":"string"},"path":{"type":"string"},"old_string":{"type":"string"},"new_string":{"type":"string"}},"required":["project","path","old_string","new_string"]}}},
  ];
